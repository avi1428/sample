 ...
 function check(lyear)
	...
	//	alert(dd+"/"+mm+"/"+yy+"    "+j+"/"+k+"/"+l);
		...
		{	
			while(k!=13)
			{
				...
				else if(j==curyear && k==curmonth+1)
				{
					...
					countdays=countdays+date[k-1]-l+1;
				else
					countdays=countdays+date[k-1];
		...
		var msg=document.getElementById("msg");
						msg.innerHTML="No of Years="+countyears+"<br>"+"No of Months="+countmonths+"<br>"+"No of Days="+countdays;
						msg.innerHTML+="<br>NO of Hours="+hours+"<br>"+"No of Minutes="+mins+"<br>"+"No of Seconds="+secs;
